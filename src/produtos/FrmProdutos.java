...
public class FrmProdutos extends javax.swing.JInternalFrame {
    ...
    public FrmProdutos() {
     ...
     void atualizarDados() {
        ...
        tipo.setText(tabela.getValueAt(linha, 1).toString());
    ...
    private void initComponents() {
        ...
        tipo = new app.bolivia.swing.JCTextField();
        ...
        jPanel2.add(codigoL, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 30, 240, 52));
        ...
        tipo.setBackground(new java.awt.Color(34, 102, 145));
        tipo.setBorder(null);
        tipo.setForeground(new java.awt.Color(255, 255, 255));
        tipo.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        tipo.setPhColor(new java.awt.Color(255, 255, 255));
        tipo.setPlaceholder("MODELO");
        ...
        jPanel2.add(tipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 40, 190, 40));
        ...
        registrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/produtos/create.png"))); // NOI18N
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
          if (selecionarRegistro) {
            ...
            if (codigo.getText().equals("") || nome.getText().equals("") || tipo.getText().equals("TIPO PRODUTO")
                     || valor.equals("")) {
        ...
        if (tabela.getRowCount() > 0) {
            if (tabela.getSelectedRowCount() > 0) {
                ...
                if (codigo.getText().equals("") || nome.getText().equals("") 
                        || tipo.getText().equals("TIPO PRODUTO") || valor.equals("")) {
    ...
    private app.bolivia.swing.JCTextField tipo;
